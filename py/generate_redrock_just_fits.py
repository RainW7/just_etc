...
- Environment Variable: RR_TEMPLATE_DIR=/Users/rain/JUST_ETC/redrock/py/redrock/templates
...
from dwarf_ssp_model import build_dwarf_ssp_spectrum
...
def generate_just_redrock_fits(output_fits_path, targets_config, t_exp=900.0, n_exp=4):
    ...
    for idx, targ in enumerate(targets_config):
        ...
        if t_type == 'ssp_dwarf':
            ...
            tpl_path = _V1_DIR / "templates" / targ['template_file']

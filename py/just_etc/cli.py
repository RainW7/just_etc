...
Usage Examples:
  ...
  2. Compute SNR for a given exposure time (e.g. 1800s for r=21.5 mag star):
     just-etc --mag 21.5 --band r --texp 1800 --target point

  3. Solve required exposure time for target SNR (e.g. SNR=5.0 for r=22.0 mag extended galaxy with reff=0.6"):
     just-etc --target-snr 5.0 --mag 22.0 --band r --target extended --reff 0.6
"""
...
from .resources import template_path as resolve_template_path
